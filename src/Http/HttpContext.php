...
use Palacios\Framework\Validation\ModelState;
...
final class HttpContext
{
    ...
    /** @var array{method: string, path: string, handler: mixed, middleware: array<int, string|object>, name: ?string, metadata: \Palacios\Framework\Routing\EndpointMetadataCollection}|null */
